...
void Uidocking::SetupDefaultDockspace(ImGuiID dockspace_id)
{
    ...
    ImGuiID dock_id_right_bottom = ImGui::DockBuilderSplitNode(dock_id_right, ImGuiDir_Down, 0.55f, nullptr, &dock_id_right_top);

    ImGui::DockBuilderDockWindow("Hierarchy Inspector", dock_id_left);
    ImGui::DockBuilderDockWindow("3D Viewport", dock_id_center);
    ImGui::DockBuilderDockWindow("Object Inspector", dock_id_right_top);
    ImGui::DockBuilderDockWindow("SUPER HISTORY LOGGER", dock_id_right_bottom);
